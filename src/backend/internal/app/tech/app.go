...
import (
	...
	"git.iu7.bmstu.ru/ovv20u676/ppo/src/backend/internal/menu"
...
func (a *App) Init() error {
	...
	a.menu = menu.NewMenu(billController, orderController, elemController, userController, wineController)
